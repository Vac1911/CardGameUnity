...
namespace Tools.UI.Card
{
    ...
    public abstract class UiBaseCardState : IState
    {
        ...
        protected virtual void MakeRenderFirst()
        {
            ...
            for (var i = 0; i < Handler.TextRenderers.Length; i++)
                Handler.TextRenderers[i].sortingOrder = LayerToRenderTop;
        }
        ...
        protected virtual void MakeRenderNormal()
        {
            ...
            for (var i = 0; i < Handler.TextRenderers.Length; i++)
                if (Handler.TextRenderers[i])
                    Handler.TextRenderers[i].sortingOrder = LayerToRenderNormal;
        }
