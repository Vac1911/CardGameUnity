...
namespace Extensions
{
    ...
    public static class ListExtensions
    {
        ...
        /// <summary>
        ///     Returns the item with the maximum value of a selector function.
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="list"></param>
        /// <param name="selector"></param>
        public static T MaxBy<T>(this List<T> list, Func<T, float> selector)
        {
            return list.Aggregate((minItem, nextItem) => selector(minItem) > selector(nextItem) ? minItem : nextItem);
        }


        /// <summary>
        ///     Returns the item with the minimum value of a selector function.
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="list"></param>
        /// <param name="selector"></param>
        public static T MinBy<T>(this List<T> list, Func<T, float> selector)
        {
            return list.Aggregate((minItem, nextItem) => selector(minItem) < selector(nextItem) ? minItem : nextItem);
        }
    }
