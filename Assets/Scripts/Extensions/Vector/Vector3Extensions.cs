...
namespace Extensions
{
    ...
    public static class VectorExtensions
    {
        ...
        /// <summary>
        ///     Returns a vector using the sign of each axis
        /// </summary>
        /// <param name="v">Input vector</param>
        /// <returns>Signed vector</returns>
        public static Vector3 GetSignedVector(this Vector3 v) => new Vector3(Math.Sign(v.x), Math.Sign(v.y), Math.Sign(v.z));
